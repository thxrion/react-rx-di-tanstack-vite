...
interface ISignUpPasswordComponentProps {
    value: string;
    disabled: boolean;
    error: Error | null;
...
export function SignUpPasswordComponent({ value, disabled, error, onChange }: ISignUpPasswordComponentProps): JSX.Element {
